...
public class RegisterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// Called via direct access --> forward to register.jsp
		...
		request.setAttribute("tb", languageMap.get("register_"+lang));
		RequestDispatcher dispatcher = request.getRequestDispatcher("uebung_4_Aufg3/register.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// Called via form --> forward to signin.jsp
	}
